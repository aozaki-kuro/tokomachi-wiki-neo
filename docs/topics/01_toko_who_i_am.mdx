...
This is a paid live, originally streamed on Niconico. If you are interested in their performances, you can purchase _Blu-ray Disc_ from [<Fa name={[ 'fa-solid' , 'compact-disc' ]} /> NIJISANJI Shop](https://shop.nijisanji.jp/s/niji/item/detail/NJSJ-026).
...
> [<Fa name={[ 'fa-brands' , 'youtube' ]} /> Original YouTube Stream](https://youtu.be/i8UbpU6wf1U?t=407)
...
・ [<Fa name={[ 'fa-solid' , 'calendar-days' ]} /> _Timeline: Tokomachi in 2020_](/docs/timeline/2020#inui-toko-1st-solo-live-who-i-am) &nbsp; <Fa name={[ 'fa-solid' , 'arrow-right-from-bracket' ]} />
