...
> [<Fa name={[ 'fa-brands' , 'youtube' ]} /> Timestamp: Toko's part](https://youtu.be/Ajwv4ANSSg0&t=770s)
...
> [<Fa name={[ 'fa-brands' , 'twitter' ]} /> Original Tweet 1](https://twitter.com/inui_toko/status/1381846290212954113) , [<Fa name={[ 'fa-brands' , 'twitter' ]} /> Original Tweet 2](https://twitter.com/inui_toko/status/1381848262760538112)

<details> <summary>Tweet Translation</summary>

<img
  src={require("./assets/20210413_01.jpg").default}
  style={{ width: "35rem" }}
/>
<br />
<img
  src={require("./assets/20210413_02.jpg").default}
  style={{ width: "35rem" }}
/>
...
Toko once invited Suisei to her live concert (see also: _[<Fa name={[ 'fa-solid' , 'microphone-lines' ]} /> Topics: "who i am"](/docs/topics/toko_who_i_am)_ ) and according to Suisei, she wanted to invite Toko to her live concert in return and she did.

The live audience count jumped from about 46,000 (20:12 JST) to more than 56,000 (20:22 JST).

The numbers came from [<Fa name={[ 'fa-solid' , 'play' ]} /> HoloStats](https://holo.poi.cat/stream/Ajwv4ANSSg0).

## After Talk

### Toko's Side

> [<Fa name={[ 'fa-brands' , 'youtube' ]} /> Toko's Aftertalk](https://www.youtube.com/watch?v=BNq4LHZRhfQ)
...
It seemed like hololive's staffs knew clearly about Toko's snack preferences. They put several bags of potato chips, to be specific it was Toko's favorite [<Fa name={[ 'fa-solid' , 'store' ]} /> O'zaku](https://housefoods.jp/products/catalog/cat_1,snack,pdt,oz.html) in her green room which let her felt a little bit surprised but also happy. But unfortunately she had no time for snacks so she took it back.
...
<img
  src={require("./assets/20210412_00.jpg").default}
  style={{ width: "35rem" }}
/>
<br />
<img
  src={require("./assets/20210412_01.jpg").default}
  style={{ width: "35rem" }}
/>
<br />
<img
  src={require("./assets/20210412_02.jpg").default}
  style={{ width: "35rem" }}
/>
<br />
<img
  src={require("./assets/20210412_03.jpg").default}
  style={{ width: "35rem" }}
/>
...
> [<Fa name={[ 'fa-brands' , 'youtube' ]} /> Tokomachi Radio #7](https://youtu.be/kR9mSvUyfkY)
...
・ [<Fa name={[ 'fa-solid' , 'calendar-days' ]} /> _Timeline: Tokomachi in 2021_](/docs/timeline/2021#space-for-virtual-ghost) &nbsp; <Fa name={[ 'fa-solid' , 'arrow-right-from-bracket' ]} />

・ [<Fa name={[ 'fa-solid' , 'microphone-lines' ]} /> _Topics: Tokomachi Music_](/docs/topics/music_list) &nbsp; <Fa name={[ 'fa-solid' , 'arrow-right-from-bracket' ]} />
