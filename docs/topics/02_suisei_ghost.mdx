...
Toko once invited Suisei to her live concert (see also: _[<Fa name={[ 'solid' , 'microphone-lines' ]} /> Topics: "who i am"](/docs/topics/toko_who_i_am)_ ) and according to Suisei, she wanted to invite Toko to her live concert in return and she did.
...
・ [<Fa name={[ 'solid' , 'calendar-days' ]} /> _Timeline: Tokomachi in 2021_](/docs/timeline/2021#space-for-virtual-ghost) &nbsp; <Fa name={[ 'solid' , 'arrow-right-from-bracket' ]} />

・ [<Fa name={[ 'solid' , 'microphone-lines' ]} /> _Topics: Tokomachi Music_](/docs/topics/music_list) &nbsp; <Fa name={[ 'solid' , 'arrow-right-from-bracket' ]} />
