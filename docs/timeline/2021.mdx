...
>> _<Fa name={[ 'solid' , 'heart' ]} /> Melty ♡ Kitchen, Ra\*bits (Ensemble Stars!!)_
...
> [<Fa name={[ 'brands' , 'youtube' ]} /> _Timestamp: Toko singing a little bit Tenkyuu_](https://www.youtube.com/watch?v=nzM4du2xWXo&t=3800s)
...
> [<Fa name={[ 'brands' , 'youtube' ]} /> _Timestamp: About Tenkyuu and GHOST_](https://www.youtube.com/watch?v=bxK7WHO5Y7k&t=1448s)
...
>> _<Fa name={[ 'solid' , 'egg' ]} /> Ester · Carnival, Switch (Ensemble Stars!!)_

This was the 4th MV, originally planned to post for Ester.
...
![1st Anniversary](../topics/assets/suisei_ghost.jpg)
