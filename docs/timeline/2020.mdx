...
Suisei also asked the clippers not to clip this because she felt pretty shy and worried about if Toko would see this. Well, the clip still got noticed by Toko and [something even more interesting](/docs/timeline/2021#small-revenge) happened a year later.
...
_For more information, please read [<Fa name={[ 'solid' , 'microphone-lines' ]} /> Topics: Tokomachi Radio](/docs/radio/tokomachi_radio_s1)._
...
_For more information, please read [<Fa name={[ 'solid' , 'microphone-lines' ]} /> Topics: Music Main List](/docs/topics/music_list)._
...
Suisei and Toko finally fulfilled [their dreams back in 2019](/docs/timeline/2019#2019-06-08).

_For more information, please read [<Fa name={[ 'solid' , 'microphone-lines' ]} /> Topics: "who i am"](/docs/topics/toko_who_i_am)._
