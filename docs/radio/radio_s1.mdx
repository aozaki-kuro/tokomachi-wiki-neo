...
Ref: [<Fa name={[ 'fa-solid' , 'play' ]} /> _hololive official website: OUT OF FRAME_](https://hololive.hololivepro.com/en/music/out-of-frame/)
...
> [<Fa name={[ 'fa-brands' , 'youtube' ]} /> Original YouTube Stream](https://youtu.be/Kr1jxq0ms00)

This is the first episode in 2021 so there were a lot of talks about the new year plans.

#### Confirmation

> [<Fa name={[ 'fa-brands' , 'youtube' ]} /> Timestamp: Confirmation](https://youtu.be/VH0XOn6ceSA?t=282)
...
> [<Fa name={[ 'fa-brands' , 'youtube' ]} /> Original YouTube Stream](https://youtu.be/kR9mSvUyfkY)
...
_For more information, please read [<Fa name={[ 'fa-solid' , 'microphone-lines' ]} /> Topics: SPACE for Virtual GHOST](/docs/topics/suisei_ghost#tokomachi-side)._

#### Other Topics

The best songs for them were _Ensemble Stars_ songs.

If they are going to have a band, Suisei would be the pianist and Toko would play [<Fa name={[ 'fa-brands' , 'wikipedia-w' ]} /> Shakuhachi](https://en.wikipedia.org/wiki/Shakuhachi).
...
・ [<Fa name={[ 'fa-solid' , 'microphone-lines' ]} /> _Topics: Tokomachi Radio Season 02_](/docs/radio/tokomachi_radio_s2) &nbsp; <Fa name={[ 'fa-solid' , 'arrow-right-from-bracket' ]} />

・ [<Fa name={[ 'fa-solid' , 'microphone-lines' ]} /> _Timeline: Tokomachi in 2020_](/docs/timeline/2020) &nbsp; <Fa name={[ 'fa-solid' , 'arrow-right-from-bracket' ]} />
